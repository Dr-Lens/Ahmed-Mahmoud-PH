...
import type { Photo, UploadTask } from "../types/index.js";

export const getPhotos = (albumId: string) => apiGet<Photo[]>("getPhotos", { albumId });

export const deletePhoto = (photo_id: string) => apiPost<void>("deletePhoto", { photo_id });

export const reorderPhotos = (albumId: string, order: { photo_id: string; sort_order: number }[]) =>
  apiPost<void>("reorderPhotos", { albumId, order });
