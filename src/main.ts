...
function buildShell(): HTMLElement {
  ...
  if (!outlet) throw new Error("Missing #outlet element in index.html");
  return outlet;
}
 ...
 */
async function renderAdminRoute(outlet: HTMLElement): Promise<void> {
...
function main(): void {
  ...
  const chromeEls = document.querySelectorAll<HTMLElement>("[data-public-chrome]");
  const syncChrome = () => {
